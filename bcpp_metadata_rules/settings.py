"""
Django settings for bcpp_metadata_rules project.
...
SECRET_KEY = 'yy1gy=vk(w2jp+rs)zh0g*md^1)k1txr#=88t3u*^qlt0sgi7o'
...
ROOT_URLCONF = 'bcpp_metadata_rules.urls'
...
WSGI_APPLICATION = 'bcpp_metadata_rules.wsgi.application'
